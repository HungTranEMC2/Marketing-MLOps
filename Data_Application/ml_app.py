...
def run_ml():
	...
	if st.button("Use XGBoost"):
		...
		model = load_model("/Users/alextran/Documents/GitHub/Marketing-MLOps/Data_Science/model_xgb.pkl")
	...
	if st.button("Use Random Forest"):
		sample = np.array(single_sample).reshape(1,-1)
		model = load_model("/Users/alextran/Documents/GitHub/Marketing-MLOps/Data_Science/model_random_forest.pkl")
		prediction = model.predict(sample)
