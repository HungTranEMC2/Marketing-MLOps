...
def clean_data(df):
    column_names = ['gender','age','occupation numeric','city_category','stay_in_current_city_years','marital_status','product_category_1','product_category_2','product_category_3','purchase_amount']
